...
class Shopkeep{
    private: 
        ...
        Potion potions;     // vector array of potion items
        vector<Item> storage[3];    // an array of item vectors. There will be three rows and many columns
                                        // row 0 --> Weapons
                                        // row 1 --> Armor
                                        // row 2 --> Potions
    ...
    public:  
        ...
        Weapon getWeapons(int index) const;
        Armor getArmors(int index) const;
